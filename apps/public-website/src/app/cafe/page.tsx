  ...
  return (
    <main className="relative min-h-screen flex flex-col bg-black text-slate-100 font-sans">
      <div className="w-full flex-1 flex flex-col bg-brand-dark relative">
        {/* Background Glows */}
        <div className="absolute top-[-10%] left-[-10%] w-[60%] h-[60%] bg-[radial-gradient(circle_at_center,rgb(var(--color-amber)/0.06)_0%,transparent_65%)] pointer-events-none" />
        <div className="absolute bottom-0 right-[-10%] w-[60%] h-[60%] bg-[radial-gradient(circle_at_center,rgb(var(--color-amber)/0.04)_0%,transparent_65%)] pointer-events-none" />
      ...
      <section className="relative pt-40 pb-20 px-6 max-w-7xl mx-auto w-full flex flex-col items-center text-center">
        <motion.div
          ...
          className="inline-flex items-center space-x-2 text-amber-500 font-semibold tracking-wide text-xs md:text-sm uppercase mb-4"
        >
        ...
        <motion.p
          ...
          className="max-w-xl text-slate-400 text-sm md:text-base leading-relaxed mb-8"
        >
        ...
        >
          <button
            ...
            className="px-8 py-4 rounded-full font-display font-extrabold uppercase tracking-wide text-xs bg-amber-500 hover:bg-amber-400 text-brand-dark shadow-lg shadow-amber-500/20 transition-all flex items-center space-x-2"
          >
      ...
      <section className="w-full px-4 md:px-8 lg:px-12 xl:px-16 pb-24">
        <div className="flex flex-col space-y-2 mb-8">
          <span className="text-micro text-amber-500 font-bold uppercase tracking-eyebrow">Visual Gallery</span>
      ...
      <section className="w-full px-4 md:px-8 lg:px-12 xl:px-16 pb-24">
        <div className="flex flex-col space-y-2 mb-10">
          <span className="text-micro text-amber-500 font-bold uppercase tracking-eyebrow">The Kitchen Selection</span>
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <span className="bg-amber-500/10 text-amber-400 border border-amber-500/20 text-micro font-extrabold tracking-wide uppercase px-3 py-1 rounded-full">
                    {dish.tag}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6 md:p-8 flex-1 flex flex-col justify-between space-y-4">
                <div>
                  <span className="text-micro font-bold text-slate-500 uppercase tracking-caps block mb-1">
                    {dish.category}
                  </span>
                ...
                <div className="flex justify-between items-center pt-4 border-t border-neutral-900">
                  <span className="text-micro text-slate-500 uppercase tracking-wide font-semibold">PRICE</span>
